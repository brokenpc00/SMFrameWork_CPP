...
#include "SpriteFilterAmaro.h"
#include "FilterShaderString.h"
#include <cocos2d.h>


SpriteFilterAmaro * SpriteFilterAmaro::createWithTexture(cocos2d::Texture2D *texture)
{
    auto sprite = new (std::nothrow)SpriteFilterAmaro();
...
SpriteFilterAmaro::SpriteFilterAmaro() : _ext1(nullptr)
{
    
}

SpriteFilterAmaro::~SpriteFilterAmaro()
{
...
bool SpriteFilterAmaro::initWithTexture(cocos2d::Texture2D *texture)
{
    ...
    _ext2->retain();
    auto addedSprite3 = cocos2d::Sprite::create("LookupImage/amaroMap.png");
    _ext3 = addedSprite3->getTexture();
    _ext3->retain();
    
    std::string shaderKey = "AmaroShader";
    
    auto program = cocos2d::GLProgramCache::getInstance()->getGLProgram(shaderKey);
    if (program==nullptr) {
        program = cocos2d::GLProgram::createWithByteArrays(FilterShaderString::FILTER_VS_BASE.c_str(), FilterShaderString::FILTER_FS_AMARO.c_str());
...
void SpriteFilterAmaro::draw(cocos2d::Renderer *renderer, const cocos2d::Mat4 &transform, uint32_t flags)
{
    ...
    _customCommand.func = CC_CALLBACK_0(SpriteFilterAmaro::onDraw, this, transform, flags);
    renderer->addCommand(&_customCommand);
}

void SpriteFilterAmaro::onDraw(const cocos2d::Mat4 &transform, uint32_t flags)
{
