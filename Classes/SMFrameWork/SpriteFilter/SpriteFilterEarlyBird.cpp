...
#include "SpriteFilterEarlyBird.h"
#include "FilterShaderString.h"
#include <cocos2d.h>


SpriteFilterEarlyBird * SpriteFilterEarlyBird::createWithTexture(cocos2d::Texture2D *texture)
{
    auto sprite = new (std::nothrow)SpriteFilterEarlyBird();
...
SpriteFilterEarlyBird::SpriteFilterEarlyBird() :
_ext1(nullptr)
, _ext2(nullptr)
, _ext3(nullptr)
//, _ext4(nullptr)
...
bool SpriteFilterEarlyBird::initWithTexture(cocos2d::Texture2D *texture)
{
    if (!cocos2d::Sprite::initWithTexture(texture)) {
        return false;
    }
    
    auto addedSprite = cocos2d::Sprite::create("LookupImage/earlyBirdCurves.png");
    _ext1 = addedSprite->getTexture();
    _ext1->retain();
    auto addedSprite2 = cocos2d::Sprite::create("LookupImage/earlybirdOverlayMap.png");
    _ext2 = addedSprite2->getTexture();
    _ext2->retain();
    auto addedSprite3 = cocos2d::Sprite::create("LookupImage/vignetteMap.png");
    _ext3 = addedSprite3->getTexture();
    _ext3->retain();
//    auto addedSprite4= cocos2d::Sprite::create("LookupImage/earlybirdBlowout.png");
//    _ext4 = addedSprite4->getTexture();
//    _ext4->retain();
    auto addedSprite5 = cocos2d::Sprite::create("LookupImage/earlybirdMap.png");
    _ext5 = addedSprite5->getTexture();
    _ext5->retain();
    
    std::string shaderKey = "EarlyBirdShader";
    
    auto program = cocos2d::GLProgramCache::getInstance()->getGLProgram(shaderKey);
    if (program==nullptr) {
        program = cocos2d::GLProgram::createWithByteArrays(FilterShaderString::FILTER_VS_BASE.c_str(), FilterShaderString::FILTER_FS_EARLYBIRD.c_str());
...
void SpriteFilterEarlyBird::draw(cocos2d::Renderer *renderer, const cocos2d::Mat4 &transform, uint32_t flags)
{
    ...
    _customCommand.func = CC_CALLBACK_0(SpriteFilterEarlyBird::onDraw, this, transform, flags);
    renderer->addCommand(&_customCommand);
}

void SpriteFilterEarlyBird::onDraw(const cocos2d::Mat4 &transform, uint32_t flags)
{
